...
function buildCreatePackagePrompt(query: string) {
	return `I searched Kody Community for "${query}" and found no published package. Create this package for me. First open search({ entity: ["package_authoring:guide", "package_lifecycle:guide"] }). Then choose a suitable lower-kebab-case kody_id and call packageGetGitRemote({ kody_id, create: true }) to create its repository. Build, test, and publish a useful package that matches my search.`
}
