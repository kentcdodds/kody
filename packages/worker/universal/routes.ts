...
export const routes = route({
	...
	accountEmailDestinationsApi: '/account/email-destinations.json',
	accountEmailDestinationsApiPost: post('/account/email-destinations.json'),
	...
	verifyEmailDestination: '/verify-email-destination',
