...
function mockJobDoNamespace(): DurableObjectNamespace {
	return {
		idFromName() {
			return { toString: () => 'job-do-test-id' } as DurableObjectId
		},
		get() {
...
function createEnv(
	...
	return {
		...
		JOB_MANAGER: mockJobDoNamespace(),
		JOB_RUNNER: mockJobDoNamespace(),
	} as unknown as Env
}
