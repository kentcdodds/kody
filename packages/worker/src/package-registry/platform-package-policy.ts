...
export const personPackagePlatformDependencyMessage =
	'Official platform packages are not runnable from a person account. communityFork the official package into your scope and import that copy — platform APIs are not a live dependency.'
