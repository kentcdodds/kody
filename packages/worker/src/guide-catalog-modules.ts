 ...
 * negligible size to whichever Worker registers `coding_guide_get`.
 *
 ...
 * calls the `coding_guide_get` handler. Merely registering the capability
 * does not add guide-catalog parse/link cost to the main module's cold
 * start.
 */
