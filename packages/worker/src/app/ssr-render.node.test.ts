...
test('renderAppPage server-renders simplified integration and secret-approval pages', async () => {
	...
	expect(connectionHtml).toContain('data-testid="add-account-form"')
	expect(connectionHtml).toContain('Connection name')
	expect(connectionHtml).toContain('value="google-2"')
	...
	expect(builtInHtml).toContain('data-testid="add-account-form"')
	expect(builtInHtml).toContain('value="google-2"')
