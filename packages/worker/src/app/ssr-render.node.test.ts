...
test('renderAppPage embeds the homepage factory-loop conversation teaser', async () => {
	...
	expect(html).toContain('Ask once.')
	expect(html).toContain('Save it.')
	expect(html).toContain('Trigger it.')
	expect(html).toContain('class="landing-path-rail"')
	expect(html).toContain('Ad hoc prompt')
	expect(html).toContain('Your own <em>git</em> and <em>npm</em>.')
	expect(html).toContain('Your git')
	expect(html).toContain('A <em>secure</em> vault for your <em>secrets</em>.')
	expect(html).toContain('href="/docs/secrets"')
	expect(html).toContain('How secrets work')
