...
import {
	...
	createGuideDetailOgImageHandler,
	createGuidesApiHandler,
	createGuidesConnectApiHandler,
	createGuidesConnectHandler,
...
export function createAppRouter(env: Env) {
	...
	router.map(routes, {
		actions: {
			...
			guidesConnect: createGuidesConnectHandler(env),
			guidesConnectApi: createGuidesConnectApiHandler(env),
			guidesConnectMarkdown: createGuidesConnectMarkdownHandler(env),
