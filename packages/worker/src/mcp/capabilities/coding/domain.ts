...
export const codingDomain = defineDomain({
	...
	description:
		'Software work such as billed page-to-markdown fallback for hard-to-read web pages, generated UI guides, and coding-agent workflows. Prefer normal fetch, browser tools, or saved skills before the billed fallback. For Cloudflare API v4 and developers.cloudflare.com doc patterns, see docs/contributing/skill-patterns/.',
	capabilities: [
