...
- Execute-time code already includes \`refreshAccessToken(providerName)\` and \`createAuthenticatedFetch(providerName)\` helpers for connector OAuth flows; you do not need to import them or bind them to \`codemode\`.
