/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./packages/worker/worker-configuration.d.ts --config packages/worker/wrangler.jsonc --env production` (hash: f460224c45cb9da71a1b3fda65a62ffd)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SENTRY_ENVIRONMENT" | "ARTIFACTS_NAMESPACE" | "WORKFLOW_CONCURRENT_LIMIT" | "COOKIE_SECRET" | "SECRET_STORE_KEY" | "APP_BASE_URL">> {}
}
