/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/worker/wrangler.jsonc --env=production ./packages/worker/worker-configuration.d.ts` (hash: 01b54a23c86f417d821d0b5681ba5318)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "MCP" | "JobManager" | "StorageRunner" | "RepoSession" | "PackageRealtimeSession" | "PackageServiceInstance" | "RemoteConnectorSession" | "McpClientHub" | "OAuthPurgeCoordinator" | "RunLog" | "UserMeter" | "StripePlanRefresh";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SENTRY_ENVIRONMENT" | "SIGNUP_MODE" | "SENTRY_TRACES_SAMPLE_RATE" | "ARTIFACTS_NAMESPACE" | "PACKAGE_APP_BASE_URL" | "FATHOM_SITE_ID" | "STRIPE_PRO_PRICE_ID" | "DR_EXPORT_ENABLED" | "DR_BACKUP_ACCOUNT_ID" | "DR_BACKUP_BUCKET_NAME">> {}
}
declare module "*.md" {
	const value: string;
