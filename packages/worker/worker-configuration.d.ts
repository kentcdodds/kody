/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./packages/worker/worker-configuration.d.ts --config packages/worker/wrangler.jsonc --env production` (hash: 06a0ba01733430a00fd583b91c3f3424)
// Runtime types generated with workerd@1.20260415.1 2026-04-16 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MCP" | "ChatAgent" | "JobManager" | "StorageRunner" | "AgentTurnRunner" | "RepoSession" | "PackageRealtimeSession" | "PackageServiceInstance" | "RemoteConnectorSession";
	}
	interface Env {
