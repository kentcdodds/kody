/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./packages/worker/worker-configuration.d.ts --config packages/worker/wrangler.jsonc --env production` (hash: 7ebebc67f1a93f74eec6a54689922030)
// Runtime types generated with workerd@1.20260415.1 2026-04-16 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MCP" | "ChatAgent" | "HomeConnectorSession" | "HomeMCP" | "JobManager" | "StorageRunner" | "AgentTurnRunner" | "RepoSession" | "PackageRealtimeSession" | "PackageServiceInstance" | "Sandbox";
	}
	interface Env {
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_MODE" | "AI_MODEL" | "SENTRY_ENVIRONMENT" | "COOKIE_SECRET" | "SECRET_STORE_KEY" | "APP_BASE_URL">> {}
}
