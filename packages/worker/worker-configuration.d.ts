/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./packages/worker/worker-configuration.d.ts --config packages/worker/wrangler.jsonc --env production` (hash: 7f1f769d929f1cc3f01caf4a36a8cd3c)
// Runtime types generated with workerd@1.20260409.1 2026-04-13 experimental,global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MCP" | "ChatAgent" | "HomeConnectorSession" | "HomeMCP" | "SchedulerDO" | "AppRunner" | "JobRunner";
	}
	interface Env {
