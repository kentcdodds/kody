/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./packages/worker/worker-configuration.d.ts --config packages/worker/wrangler.jsonc --env production` (hash: b210ee17d0b478b5bee3d67785ac550b)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SENTRY_ENVIRONMENT" | "WORKFLOW_CONCURRENT_LIMIT" | "COOKIE_SECRET" | "SECRET_STORE_KEY" | "APP_BASE_URL">> {}
}
