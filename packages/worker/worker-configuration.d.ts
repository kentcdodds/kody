/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./packages/worker/worker-configuration.d.ts --config packages/worker/wrangler.jsonc --env production` (hash: dfd7385fe46a03cbe95b1a2ff69c703b)
// Runtime types generated with workerd@1.20260415.1 2026-04-13 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MCP" | "ChatAgent" | "HomeConnectorSession" | "HomeMCP" | "AppRunner" | "JobManager" | "StorageRunner" | "AgentTurnRunner" | "RepoSession";
	}
	interface Env {
		...
		REPO_SESSION: DurableObjectNamespace /* RepoSession */;
