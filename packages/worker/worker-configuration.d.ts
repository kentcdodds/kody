/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/worker/wrangler.jsonc --env=production ./packages/worker/worker-configuration.d.ts` (hash: cb3e9e165e5b46f95739392e7c67946e)
...
interface __BaseEnv_Env {
	...
	USER_EMAIL_DOMAIN: "inbox.heykody.dev";
