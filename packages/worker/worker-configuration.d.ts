/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/worker/wrangler.jsonc --env=production ./packages/worker/worker-configuration.d.ts` (hash: 2613ef7169f1fa83e5eb0a2bf6a487ce)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SENTRY_ENVIRONMENT" | "SIGNUP_MODE" | "SENTRY_TRACES_SAMPLE_RATE" | "ARTIFACTS_NAMESPACE" | "PACKAGE_APP_BASE_URL" | "FATHOM_SITE_ID" | "DR_EXPORT_ENABLED" | "DR_BACKUP_ACCOUNT_ID" | "DR_BACKUP_BUCKET_NAME" | "COOKIE_SECRET" | "SECRET_STORE_KEY">> {}
}
declare module "*.md" {
	const value: string;
