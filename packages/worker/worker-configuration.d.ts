/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/worker/wrangler.jsonc --env=production ./packages/worker/worker-configuration.d.ts` (hash: 74b7c1c8eb946dd2db60af697ef49141)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "MCP" | "StorageRunner" | "RepoSession" | "PackageRealtimeSession" | "PackageServiceInstance" | "RemoteConnectorSession" | "McpClientHub" | "OAuthPurgeCoordinator" | "RunLog" | "UserMeter" | "Mailbox" | "StripePlanRefresh";
	}
