/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/worker/wrangler.jsonc --env=production ./packages/worker/worker-configuration.d.ts` (hash: b5d52c9ee50ad204ad2af4725993a8eb)
...
interface __BaseEnv_Env {
	...
	COMMUNITY_LISTING_PUBLISHED_DISPATCH_QUEUE: Queue;
	...
	MCP_OBJECT: DurableObjectNamespace /* MCP from kody-platform */;
	MCP_CLIENT_HUB: DurableObjectNamespace /* McpClientHub from kody-platform */;
	OAUTH_PURGE_COORDINATOR: DurableObjectNamespace /* OAuthPurgeCoordinator from kody-platform */;
	...
	USER_METER: DurableObjectNamespace /* UserMeter from kody-platform */;
	MAILBOX: DurableObjectNamespace /* Mailbox from kody-platform */;
	REPO_SESSION_INDEX: DurableObjectNamespace /* RepoSessionIndex from kody-platform */;
	STRIPE_PLAN_REFRESH: DurableObjectNamespace /* StripePlanRefresh from kody-platform */;
	REPO_SESSION: DurableObjectNamespace /* RepoSession from kody-platform */;
