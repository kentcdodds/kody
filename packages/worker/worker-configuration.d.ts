/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/worker/wrangler.jsonc --env=production ./packages/worker/worker-configuration.d.ts` (hash: ff721fcd9d867202d94fb7f9ffbd1993)
// Runtime types generated with workerd@1.20260730.1 2026-04-16 global_fetch_strictly_public,nodejs_compat
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "MCP" | "JobManager" | "StorageRunner" | "RepoSession" | "PackageRealtimeSession" | "PackageServiceInstance" | "RemoteConnectorSession" | "McpClientHub" | "OAuthPurgeCoordinator" | "RunLog" | "UserMeter" | "Mailbox" | "StripePlanRefresh";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SENTRY_ENVIRONMENT" | "SIGNUP_MODE" | "SENTRY_TRACES_SAMPLE_RATE" | "ARTIFACTS_NAMESPACE" | "PACKAGE_APP_BASE_URL" | "FATHOM_SITE_ID" | "STRIPE_PRO_PRICE_ID" | "DR_EXPORT_ENABLED" | "DR_BACKUP_ACCOUNT_ID" | "DR_BACKUP_BUCKET_NAME" | "COOKIE_SECRET" | "SECRET_STORE_KEY" | "APP_BASE_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "X_CLIENT_ID" | "X_CLIENT_SECRET">> {}
}
declare module "*.md" {
	const value: string;
