/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/worker/wrangler.jsonc --env=production ./packages/worker/worker-configuration.d.ts` (hash: 51c572bf4657f5fa701259f243e1a82f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SENTRY_ENVIRONMENT" | "SENTRY_TRACES_SAMPLE_RATE" | "ARTIFACTS_NAMESPACE" | "FATHOM_SITE_ID" | "STRIPE_PRO_PRICE_ID" | "DR_EXPORT_ENABLED" | "DR_BACKUP_ACCOUNT_ID" | "DR_BACKUP_BUCKET_NAME" | "COOKIE_SECRET" | "SECRET_STORE_KEY" | "APP_BASE_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "X_CLIENT_ID" | "X_CLIENT_SECRET">> {}
}
declare module "*.md" {
	const value: string;
