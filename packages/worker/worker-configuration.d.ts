/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./packages/worker/worker-configuration.d.ts --config packages/worker/wrangler.jsonc --env production` (hash: d2696efb55471114b3b1b7c9abaf06e6)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		PACKAGE_EVENT_WORKFLOW: Workflow<Parameters<import("./src/index").PackageEventWorkflow['run']>[0]['payload']>;
	}
}
