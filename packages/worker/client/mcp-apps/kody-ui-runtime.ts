...
export type BuildGeneratedUiHeadInjectionInput = {
	...
	baseHref: string | null
	/**
	 * When false, omit the internal runtime module script. Use when the generated
	 * UI shell has already loaded the public `kody-ui-utils.js` entry and the
	 * shell will trigger hooks/init after rewriting the document.
	 */
