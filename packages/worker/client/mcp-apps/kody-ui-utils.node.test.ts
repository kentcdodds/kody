...
test('buildCapabilitiesExecuteCode runs the intended capability with the original args', async () => {
	const code = buildCapabilitiesExecuteCode('value_set', {
		name: 'workspaceSlug',
		value: 'kody',
		scope: 'app',
	})
