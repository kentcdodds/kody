...
an ancestor of the fork tip. Fork-ahead (the pin is already in the fork history)
is not returned to agents. When `listing_ahead` is true, the owner profile, the
