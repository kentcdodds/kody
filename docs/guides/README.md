...
| [quick-example.md](./quick-example.md)                                                   | **Start here** after a host authorizes: connect Notion or Linear, run one ad hoc execute, persist the owned package, offer optional triggers                                                                                        |
...
| [package-subscriptions.md](./package-subscriptions.md)                                   | Package subscription manifest shape, discovery, and email / repo lifecycle / run.error.recorded / integration.auth.failed / integration.auth.succeeded / admin topic payload guidance (including fleet.package_error_rate.elevated) |
