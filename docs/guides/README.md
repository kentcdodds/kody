...
| [quick-example.md](./quick-example.md)                                                   | **Start here** after a host authorizes: connect a workspace MCP, run one ad hoc execute, persist the owned package, offer optional triggers                                                                                                                       |
| [first-win.md](./first-win.md)                                                           | Optional email → reply → memories loop (not the onboarding Step 3 climax)                                                                                                                                                                                         |
