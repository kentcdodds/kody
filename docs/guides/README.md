...
| [package-subscriptions.md](./package-subscriptions.md)                                   | Package subscription manifest shape, discovery, and email.message.received / email.message.quarantined / email.system-message.received payload guidance |
