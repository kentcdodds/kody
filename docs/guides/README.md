...
| Section            | Files                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Introduction       | [what-is-kody.md](./what-is-kody.md), [how-kody-works.md](./how-kody-works.md), [kody-factory.md](./kody-factory.md)                                                                                                                                                                                                                                                                                                                                 |
...
| Packages           | [package-lifecycle.md](./package-lifecycle.md), [package-authoring.md](./package-authoring.md), [package-apps.md](./package-apps.md), [package-subscriptions.md](./package-subscriptions.md), [heavy-work-offload.md](./heavy-work-offload.md)                                                                                                                                                                                                       |
