...
| [quick-example.md](./quick-example.md)                                                   | **Start here** after a host authorizes: give Kody access, run one ad hoc execute, persist the owned package, offer optional triggers                                                                                                                              |
| [first-win.md](./first-win.md)                                                           | Optional email → reply → memories loop (not a wizard step; Step 3 climax is [quick-example.md](./quick-example.md)). Wizard/checklist alignment lives in `packages/worker/universal/onboarding-process.ts` and is checked by `onboarding-process.node.test.ts`.   |
...
| [package-subscriptions.md](./package-subscriptions.md)                                   | Package subscription manifest shape, discovery, and email / repo lifecycle / run.error.recorded / integration.auth.failed / integration.auth.succeeded / admin topic payload guidance (including fleet.package_error_rate.elevated and fleet.entitlement.crossed) |
