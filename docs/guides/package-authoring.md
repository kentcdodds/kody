...
2. Capture Kent's user-defined goal in a few concrete sentences.
3. Ask Kent when the intent is unclear or underspecified.
4. Update the intent only when you are confident the goal changed.
5. If Kent expands the package scope, update the section with the new scope.
