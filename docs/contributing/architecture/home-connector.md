...
home connector WebSocket when the connector host is inside the user's LAN and
can resolve `my.islandrouter.com` through the router's intercepting DNS. It will
not work from a host outside that LAN path.
