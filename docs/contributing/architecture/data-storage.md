...
- `secret_buckets`: encrypted-secret ownership buckets scoped to `user`,
  ...
  or adoption state.
- `user_oauth_apps` (`0100-user-oauth-apps-and-integrations.sql`): per-user
...
- `user_integrations` (`0100-user-oauth-apps-and-integrations.sql`): per-user
...
- `user_oauth_apps.extra_authorize_params_json`,
  ...
  (`0100-user-oauth-apps-and-integrations.sql`,
