/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./types/worker-configuration.d.ts --config packages/worker/wrangler.jsonc --env production` (hash: 312967305e71f634cf5b1f37791031d4)
// Runtime types generated with workerd@1.20260310.1 2026-01-31 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../packages/worker/src/index");
		durableNamespaces: "MCP" | "ChatAgent" | "HomeConnectorSession" | "HomeMCP";
	}
	interface Env {
		...
		MCP_OBJECT: DurableObjectNamespace<import("../packages/worker/src/index").MCP>;
		ChatAgent: DurableObjectNamespace<import("../packages/worker/src/index").ChatAgent>;
		HOME_CONNECTOR_SESSION: DurableObjectNamespace<import("../packages/worker/src/index").HomeConnectorSession>;
		HOME_MCP_OBJECT: DurableObjectNamespace<import("../packages/worker/src/index").HomeMCP>;
	}
}
